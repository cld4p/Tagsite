...
item replace entity @s armor.chest with iron_chestplate[custom_name=[{"text":"Blight Gear","italic":false,"color":"gold"}],enchantment_glint_override=false,enchantments={binding_curse:1},equippable={slot:chest,asset_id:"site:blight"},unbreakable={},item_model="site:blight_chestplate",tooltip_display={hidden_components:[enchantments,tooltip_display]}]
item replace entity @s armor.legs with iron_leggings[custom_name=[{"text":"Blight Gear","italic":false,"color":"gold"}],enchantment_glint_override=false,enchantments={binding_curse:1},equippable={slot:legs,asset_id:"site:blight"},unbreakable={},item_model="site:blight_leggings",tooltip_display={hidden_components:[enchantments,tooltip_display]}]
item replace entity @s armor.feet with iron_boots[custom_name=[{"text":"Blight Gear","italic":false,"color":"gold"}],enchantment_glint_override=false,enchantments={binding_curse:1},equippable={slot:feet,asset_id:"site:blight"},unbreakable={},item_model="site:blight_boots",tooltip_display={hidden_components:[enchantments,tooltip_display]}]
...
execute if entity @s[tag=c_ies] run function tgs:items/give/blight_ies
execute if entity @s[tag=c_radar] run function tgs:items/give/blight_radar_torpedo
execute if entity @s[tag=c_explosive] run function tgs:items/give/blight_remote_explosive
execute if entity @s[tag=c_smoke] run function tgs:items/give/blight_smoke_bomb
